...
<head>
    ...
    <!-- Website Title -->
    <title>Cambiar Tipo Cuenta</title>
...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <div id="header" class="header">
        <div class="header-content" style=" background-image: url('../public/imagenes/header-background.jpg'); ">
            <div id="principal">
                <form class="formularioCentrado" method="POST">
                    <h2>CONFIRMAR DATOS</h2>
                    <h3 class="texto">Datos Usuario</h3>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="inputEmail4" class="texto">Correo Usuario</label>
                            <input type="email" class="form-control" id="inputEmail4" name="correo" value="<?php echo $usuario ?>" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input name="numeroCuenta" type="text" class="form-control" value="<?php echo $numeroCuenta ?>" disabled>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="inputCity" class="texto">Tipo Cuenta Actual</label>
                            <input type="text" class="form-control" name="tipo" value="<?php echo $tipo ?>" disabled>
                        </div>
                    </div>
                    <div>
                        <label class="my-1 mr-2" for="inlineFormCustomSelectPref">Nuevo TIpo</label>
                    ...
                    <button type="submit" class="btn btn-primary">Cambiar Tipo</button>
                </form>
            </div>
        </div>
    </div>
