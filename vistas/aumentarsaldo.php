...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <div id="header" class="header">
        <div class="header-content" style=" background-image: url('../public/imagenes/header-background.jpg'); ">
            <div id="principal">
                <form class='formularioCentrado'  method='POST' action="../service/clientes_cuentas_bancarias/cuentaaumentar.service.php">
                    <h1 style="color: black;">Cantidad que se Agrega</h1>
