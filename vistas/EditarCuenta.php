                ...
                <form class="formulario" method="POST" action="#" >
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="email" class="form-control" id="inputEmail4" name="correo" value="<?php echo $usuario ?>" >
                        </div>
                        <div class="form-group col-md-6">
                            <label for="inputPassword4" class="texto">Nombre</label>
                            <input type="text" class="form-control" id="inputPassword4" name="" placeholder="nombre" >
                        </div>
                    </div>
